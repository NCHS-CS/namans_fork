...
Here are previous students presentations. Note that some students opted to created a video that they will then talk to as it plays to the class (so it should have minimal or no audio to it).
